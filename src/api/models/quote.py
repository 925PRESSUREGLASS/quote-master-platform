...
class QuoteCategory(Base):
    ...
    # Hierarchy
    parent_id = Column(GUID(), ForeignKey("quote_categories.id"), nullable=True)
...
class Quote(Base):
    ...
    category_id = Column(GUID(), ForeignKey("quote_categories.id"), nullable=True)
    ...
    voice_recording_id = Column(
        GUID(), ForeignKey("voice_recordings.id"), nullable=True
    )
    ...
    favorites = relationship(
        "QuoteFavorite", back_populates="quote", cascade="all, delete-orphan"
    )
...
class QuoteCollectionItem(Base):
    ...
    # Foreign keys
    collection_id = Column(GUID(), ForeignKey("quote_collections.id"), nullable=False)
    quote_id = Column(GUID(), ForeignKey("quotes.id"), nullable=False)
